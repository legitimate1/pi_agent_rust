...
生成时间: 2026-02-14T08:28:53.904440329+00:00
来源池: `docs/extension-candidate-pool.json` (共 1000 个)
符合条件（未收录）: **777**
Pi 相关（启发式）: **322**
模式: `pi.ext.onboarding_queue.v2` （已启用仓库级别去偏）

## 前 100（从这里开始）

| 排名 | ID | 层级 | 仓库数 | 相关度 | Stars | npm/月 | 影响力 |
|---:|---|---|---:|---:|---:|---:|---:|
